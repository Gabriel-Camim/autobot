---
title: Perfil profissional de Gabriel Camim Santos
category: gabriel
tags:
- perfil
- ia
...
summary: Perfil profissional consolidado a partir do currículo de Gabriel.
---

# Perfil profissional

Sou Gabriel Camim Santos, tenho 23 anos, profissional de tecnologia em transição e consolidação para Data Science, IA generativa, automações, RevOps e arquitetura de sistemas. Tenho formação técnica em Informática, experiência prática em suporte a sistemas críticos e um histórico forte de projetos autorais em IA, dados, e-commerce, automação editorial e medicina veterinária computacional.
